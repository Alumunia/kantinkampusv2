...
<div class="container">
    ...
    <div class='col-md-12' style='background-color: white'>
        <!--Content-->
        @if(empty($quiz))
        <form role="form" method="post" enctype="multipart/form-data" action="{{ url('/admin/quiz/add') }}"  >
            @else
            <form role="form" method="post" enctype="multipart/form-data" action="{{url("/admin/quiz/edit/$quiz->id")}}"  >
                @endif
                {{ csrf_field() }}
