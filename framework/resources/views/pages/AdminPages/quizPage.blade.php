...
<div class="container">
    ...
    <div class='col-md-12' style='background-color: white'>
        <a class="btn btn-warning" href='{{url("/admin/quiz/add")}}' role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add quiz</a>
        <a class="btn btn-success" href='{{url("/admin/Trial/quiz/")}}' role="button"><span class="glyphicon glyphicon-th" aria-hidden="true"></span> Trial quiz</a>
        <a class="btn btn-info pull-right" href='{{url("/admin/quiz/review")}}' role="button"><span class="glyphicon glyphicon-camera" aria-hidden="true"></span> Review quiz</a>
        ...
        <table class="table table-responsive table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-info" href="{{url("/admin/quiz/edit/$quiz->id")}}" role="button">Edit</a> ||
                        <div class="btn-group dropup">
                            ...
                            <ul class="dropdown-menu">
                                <form id="member_delete" method="POST" action="{{ url('/admin/quiz/delete') }}">
                                    {{ csrf_field() }}
