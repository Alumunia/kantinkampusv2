...
//    window.location.href = "{{URL::to('/profile/'.Auth::guard('member')->user()->username.'/panel/tryOut/finish?theLastNumberInPageNow='.$take.'&theFirstNumberInPageNow='.$skip.'')}}"
    document.getElementById('top-secret').click();
    }
    }
</script>
<script>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <strong>Peringatan !!</strong> pastikan semua jawaban terisi, karena Online test tidak bisa diulang kembali. Apakah kamu sudah yakin?
            </div>
...
<div class="container">
    ...
    <div class='col-md-12'>
        <div class="well" style="background-image:url('assets/images/bg-1.png');position:fixed;z-index:3;width:210px;left:0px;">
            ...
            <p style="font-size:14px">{{ Auth::guard('member')->user()->username }}</p>
            <label for="exampleInputEmail1">Sisa waktu</label>
    ...
    <div class='col-md-12' style='background-color: white'>
        <form method="POST" id='form-review-quiz' action="{{ url('/profile/'.Auth::guard('member')->user()->username.'/panel/quiz') }}" onkeypress="return event.keyCode != 13;">
            {{ csrf_field() }}
        ...
        <!--Hidden input-->
        <button type='hidden' id='top-secret' form="form-review-quiz" type="submit" name="saveAndSubmit" value="{{$saveAndGo}}"></button>
